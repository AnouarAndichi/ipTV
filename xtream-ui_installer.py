#!/usr/bin/python
# -*- coding: utf-8 -*-
import subprocess, os, random, string, sys, shutil, socket, base64
...
MySQLCnfBase64 = ""
rMySQLCnf = base64.b64decode(MySQLCnfBase64).decode('utf-8')
...
def encrypt(rHost="127.0.0.1", rUsername="user_iptvpro", rPassword="", rDatabase="xtream_iptvpro", rServerID=1, rPort=7999):
    ...
    with open('/home/xtreamcodes/iptv_xtream_codes/config', 'wb') as rf:
        rf.write(encoded_data)

def is_docker():
    path = '/proc/1/cgroup'

    # Verifica si el archivo /proc/1/cgroup existe
    ...
    with open(path) as file:
        for line in file:
            # Busca la cadena 'docker' en el contenido del archivo
            if 'docker' in line:
                return True

    # Si 'docker' no se encontró en el archivo, entonces no estamos en un entorno Docker
    return False
